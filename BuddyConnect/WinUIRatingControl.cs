...
//TODO HERE DEFINE GET/SET Global Controls Variables for Local Variables
//xmlns:local="clr-namespace:BuddyConnect"
//<Label HorizontalOptions="Center" Text="{Binding Value, Source={Reference ratingControl}}" />
public class WinUIRatingControl : View
{
    public static BindableProperty ValueProperty = BindableProperty.Create(nameof(Value), typeof(double), typeof(WinUIRatingControl), -1.0);
    public double Value
    {
