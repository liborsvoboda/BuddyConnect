...
namespace BuddyConnect
{
    ...
    public partial class NewsListPage : ContentPage, GlobalServices
    {
        ...
        void CreateMonkeyCollection() {
            source.Add(new Monkey { Name = "Baboon", Location = "Africa & Asia", Details = "Baboons are African and Arabian Old World monkeys belonging to the genus Papio, part of the subfamily Cercopithecinae.", ImageUrl = "https://learn.microsoft.com/en-us/dotnet/maui/user-interface/controls/carouselview/media/populate-data/indicators.png?view=net-maui-8.0" });
